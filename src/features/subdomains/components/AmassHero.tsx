  ...
  return (
    <>
      <div className="grid grid-cols-[auto_1fr] gap-md mb-lg">
        <div className="flex flex-col items-center justify-center bg-surface-container py-md px-sm rounded-xl border border-outline-variant vertical-text gap-md">
          <span className="font-label-caps text-label-caps text-primary tracking-widest">网络资产收集整理</span>
        </div>
